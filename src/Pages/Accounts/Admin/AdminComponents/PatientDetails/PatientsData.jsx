...
//   // Custom sort function for Status field
//   const customSort = (a, b) => {
//     const order = ["emergency", "normal"];
//     return (
//       order.indexOf(a.Status.toLowerCase()) - order.indexOf(b.Status.toLowerCase())
//     );
//   };

//   // Function to fetch and filter patients
...
//       // Filter by joining date if search date is provided
//       if (searchJoiningDate) {
//         filteredPatients = filteredPatients.filter((patient) =>
//           patient.joining_date === searchJoiningDate
//         );
//       }
...
//   // UseEffect to call fetchPatients when any of the dependencies change
//   useEffect(() => {
//     fetchPatients();
//   }, [orderBy, searchTerm, searchJoiningDate]); // Trigger fetch whenever these change
...
//   // Get status class for Emergency and Normal
//   const getStatusClass = (status) => {
//     switch (status.toLowerCase()) {
//       case "emergency":
//         return "status-emergency"; // Red for Emergency
//       case "normal":
...
//               <button className="created_attbtn" onClick={() => setOrderBy("created_at")}>
//                 Order by Created At
//               </button>
//               <button className="doctor_namebtn" onClick={() => setOrderBy("doctor_name")}>
...
//                       </Link>
//                     </td>
//                     <td className="icon" onClick={() => handleDelete(patient.id)}>
//                       <DeleteIcon />
//                     </td>
//                   </tr>
//                 ))}
